...
export const topics: StudyTopic[] = [
  ...
  // UNIT 3.1 — Social Stratification & Inequality
  {
    id: "social-stratification",
    term: "Social stratification",
    definition: "A hierarchy in which groups in society have different statuses and different levels of privilege, power and wealth.",
    pros: [],
    cons: [],
    unit: "3.1",
  },
  {
    ...
    definition: "The differences between groups in a stratification system — for example, in income, wealth, life chances or status.",
    pros: [],
    cons: [],
    unit: "3.1",
  },
  {
    id: "social-differentiation",
    term: "Social differentiation",
    definition: "The assignment of different roles and statuses to groups and individuals within a society, without implying that any group is superior.",
    pros: [],
    cons: [],
    unit: "3.1",
  },
  {
    id: "open-society",
    term: "Open society",
    definition: "A society in which individuals can move between social roles and change statuses, e.g. through education or hard work. Typical of modern industrial societies.",
    pros: [
      "Allows social mobility based on effort and talent",
      "Status can change through education or work",
      "Stratification is dynamic, not fixed",
    ],
    cons: [
      "Inequalities still persist despite formal openness",
      "Background and wealth still strongly influence chances",
    ],
    unit: "3.1",
  },
  {
    id: "closed-society",
    term: "Closed society",
    definition: "A society in which an individual's role and status are fixed, usually by being born into a particular group (e.g. caste systems).",
    pros: [
      "Provides clear, stable social roles",
      "Strong sense of group identity and tradition",
    ],
    cons: [
      "Little or no social mobility",
      "Life chances are largely determined at birth",
      "Can entrench discrimination (e.g. gender, caste)",
    ],
    unit: "3.1",
  },
  {
    id: "status",
    term: "Status",
    definition: "A position someone holds in society. Status can be ascribed (fixed by others) or achieved (gained through effort).",
    pros: [],
    cons: [],
    unit: "3.1",
  },
  {
    ...
    definition: "A position in society given to an individual by their group or society, usually at birth (e.g. age, sex, ethnicity, caste). The individual has little control over it.",
    pros: [],
    cons: [],
    notes: ["Common in traditional, closed societies", "Life chances often determined at birth"],
    unit: "3.1",
  },
  {
    id: "achieved-status",
    term: "Achieved status",
    definition: "A position in society that an individual acquires through their own effort, choice and competition (e.g. occupation, qualifications).",
    pros: [],
    cons: [],
    notes: ["Main form of status in open societies"],
    unit: "3.1",
  },
  {
    id: "power",
    term: "Power",
    definition: "The ability to influence other people's behaviour, sometimes through force, threats (e.g. job loss, legal consequences) or authority.",
    pros: [],
    cons: [],
    unit: "3.1",
  },
  {
    id: "meritocracy",
    term: "Meritocracy",
    definition: "A system in which individuals reach the social positions they deserve based on educational achievement, talent and skills.",
    pros: [
      "Rewards effort, talent and qualifications",
      "Encourages social mobility",
      "Seen as fair in open societies",
    ],
    cons: [
      "True meritocracy is rare — background still matters",
      "Ignores unequal starting points (class, ethnicity, gender)",
      "Can be used to justify existing inequalities",
    ],
    unit: "3.1",
  },
  {
    id: "ageism",
    term: "Ageism",
    definition: "Prejudice and discrimination against people based on how old they are — most often used to describe discrimination against older people.",
    pros: [],
    cons: [],
    unit: "3.1",
  },
  {
    id: "discrimination",
    term: "Discrimination",
    definition: "Treating a person or group differently from others, often based on prejudice (e.g. by age, gender, ethnicity or class).",
    pros: [],
    cons: [],
    unit: "3.1",
  },
  {
    ...
    definition: "Lacking the basic necessities of life: food, safe drinking water, sanitation, shelter, health care, education and information.",
    pros: [],
    cons: [],
    notes: ["A fixed, universal standard", "Common in developing countries"],
    unit: "3.1",
  },
  {
    id: "relative-poverty",
    term: "Relative poverty",
    definition: "Being poor compared with others in the same society — unable to afford the standard of living considered normal in that society.",
    pros: [],
    cons: [],
    notes: ["Varies between societies and over time"],
    unit: "3.1",
  },
  {
    id: "poverty-trap",
    term: "Poverty trap",
    definition: "A situation in which poor people are unable to escape poverty — e.g. they cannot afford childcare or education that would let them earn more.",
    pros: [],
    cons: [],
    unit: "3.1",
  },
  {
    id: "wealth",
    term: "Wealth",
    definition: "Money, savings and property that can be bought or sold to generate income.",
    pros: [],
    cons: [],
    unit: "3.1",
  },
  {
    id: "modern-slavery",
    term: "Modern slavery",
    definition: "The severe exploitation of vulnerable people for personal or commercial gain, including forced labour and human trafficking.",
    pros: [],
    cons: [],
    unit: "3.1",
  },
  {
    id: "patriarchy",
    term: "Patriarchy",
    definition: "A term used by feminists for societies and organisations (including the family) in which men are dominant and women are subordinate.",
    pros: [],
    cons: [],
    unit: "3.1",
  },
  {
    id: "gendered-division-of-labour",
    term: "Gendered division of labour",
    definition: "The way societies expect women to be responsible for some tasks (e.g. cleaning, childcare, food preparation) and men for others (often paid work).",
    pros: [],
    cons: [
      "Restricts women's opportunities outside the home",
      "Limits women's financial independence",
      "Reinforces inequality in pay and status",
    ],
    unit: "3.1",
  },
  {
    id: "cultural-racism",
    term: "Cultural racism",
    definition: "Racism based on differences in ways of life — such as religion, language or customs — rather than supposed biological differences.",
    pros: [],
    cons: [],
    unit: "3.1",
  },
  {
    id: "social-class",
    term: "Social class",
    definition: "A shared economic and social status (e.g. working, middle, upper class). Sociologists most often identify class using a person's occupation, which links to income, status and living standards.",
    pros: [],
    cons: [],
    unit: "3.1",
  },
  {
    id: "capitalism",
    term: "Capitalism",
    definition: "The economic system of most countries today, based on private ownership of the means of production and the pursuit of profit.",
    pros: [],
    cons: [
      "Creates large inequalities in wealth and income",
      "Marxists argue it exploits the working class",
    ],
    unit: "3.1",
  },
  {
    id: "caste-system",
    term: "Caste system (India)",
    definition: "A traditional closed system of stratification in India in which a person's caste is ascribed at birth and largely determines their occupation, marriage and status.",
    pros: [],
    cons: [
      "Very little social mobility",
      "Lowest groups ('Untouchables'/Dalits) face severe discrimination",
      "Life chances fixed at birth",
    ],
    unit: "3.1",
  },
];
